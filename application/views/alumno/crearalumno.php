                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" action='../Alumno_ajax/crear' method='POST' novalidate>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="nacimiento" class="form-control col-md-7 col-xs-12 datepicker" data-validate-length-range="8" name="nacimiento" placeholder="" required="required" type="date">
                      </div>
                    </div>
