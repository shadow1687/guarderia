            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" action='../Tutor_ajax/crear' method='POST' novalidate>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="dni" class="form-control col-md-7 col-xs-12" data-validate-length-range="8" name="dni" placeholder="" required="required" type="text">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="nacimiento" class="form-control col-md-7 col-xs-12" data-validate-length-range="8" name="nacimiento" placeholder="" required="required" type="date">
                      </div>
                    </div>
