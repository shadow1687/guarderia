              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Maestros <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">Buscar</a></li>
                      <li><a href="<?php base_url()?>Maestro">Crear</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> Establecimientos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">Buscar</a></li>
                      <li><a href="<?php base_url()?>Establecimiento">Crear</a></li>
                    </ul>
                  </li>
